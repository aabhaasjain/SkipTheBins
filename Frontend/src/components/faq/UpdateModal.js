  ...
  const update = () => {
    ...
    if (questionValid && answerValid) {
      props.update({
        question,
        answer,
        oldAnswer: props.data.answer,
        oldQuestion: props.data.question,
        id: props.data._id,
      });
      props.close();
    }
      ...
      <Modal.Body>
        <form className="mt-4">
          <div className="form-group mt-2 form-inline">
            ...
            />
            {!questionValid && questionToggled && (
              <span className="text-danger">Question cant be empty</span>
            )}
          </div>
          <div className="form-group mt-2">
            ...
            />
            {!answerValid && answerToggled && (
              <span className="text-danger">Answer cant be empty</span>
            )}
          </div>
        </form>
      </Modal.Body>

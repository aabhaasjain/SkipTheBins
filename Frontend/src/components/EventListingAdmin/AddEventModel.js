...
function AddEventModal(props) {
  ...
  const validate = () => {
    ...
    eventLocation.trim() != ""
      ? setEventLocationValid(true)
      : setEventLocationValid(false);
      ...
      <Modal.Body>
        <form className="mt-4">
          <div className="form-group mt-2 form-inline">
            ...
            />
            {!eventNameValid && eventNameToggled && (
              <span className="text-danger">Event name cant be empty</span>
            )}
          </div>
          <div className="form-group mt-2">
            ...
            />
            {!eventLocationValid && eventLocationToggled && (
              <span className="text-danger">Location cant be empty</span>
            )}
          </div>
          <div className="form-group mt-2">
            ...
            />
            {!eventDateValid && eventDateToggled && (
              <span className="text-danger">Date cant be empty</span>
            )}
          </div>
        </form>
      </Modal.Body>
